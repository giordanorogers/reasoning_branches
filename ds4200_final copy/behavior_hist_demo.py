...
# Example usage with your three texts
texts = [base_reasoning, unconfident_reasoning, confident_reasoning]
labels = ["Base Reasoning", "Unconfident Reasoning", "Confident Reasoning"]

# OPTIONAL: add line breaks to long section names for nicer x-axis labels
section_names = [
    "initializing",
    "deduction",
    "adding<br>knowledge",
...
# ------------------------------------------------------------------------------
# Helper function to create a grouped bar chart in Plotly with a similar style
